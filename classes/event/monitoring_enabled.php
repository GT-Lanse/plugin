...
/**
 * Event triggered when LANSE course monitoring is enabled.
 *
 * @package   block_mad2api
 * @copyright 2025
 * @license   https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class monitoring_enabled extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventmonitoringenabled', 'block_mad2api');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' enabled LANSE monitoring for the course with id '{$this->courseid}'.";
    }
